...
\begin{figure}[h]
	...
	\caption{Évolution de la coordonnée d'une myosine sur un filament d'actine au cours du temps (c'est la représentation graphique de l'équation horaire $x(t)$).}
	\label{fig:myosine}
\end{figure}
