...
\paragraph{}Pour une force constante opérant pendant une durée $\Delta t$, la relation entre le travail $W$ de cette force et sa puissance $\mathcal{P}$ est :
...
\paragraph{}Pour répondre à cette question, on peut soit utiliser le PFD et intégrer pour obtenir la trajectoire et la vitesse de la pomme au point d'impact. Cette méthode est assez longue est fastidieuse. À la place, on peut simplement utiliser le théorème de l'énergie cinétique. La seule force travaillant est le poids $\vv{P} = -mg\vv{e_z}$, et ce sur le trajet de chute représenté par le vecteur déplacement $\vv{\Delta OM} = -h \vv{e_z}$. Ainsi le travail appliqué sur la pomme est :
...
\paragraph{}Dans l'atome d'hydrogène, l'électron est soumis à des forces d'interaction avec le noyau, résultant en l'énergie potentielle dont le profil est donné sur la \autoref{fig:electron}, avec $r$ la distance entre le noyau et l'électron.
...
\begin{itemize}
	\item Calculer le travail d'une force.
