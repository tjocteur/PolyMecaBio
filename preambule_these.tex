...
%\newmdtheoremenv[linecolor=red_good, linewidth=1.2pt]{def}{Def}[section]
...
\newtcolorbox{defi}[1]{enhanced,sharp corners=all,colback=white,colframe=green_good,toprule=0pt,bottomrule=0pt,leftrule=1pt,rightrule=1pt,overlay={
    \draw[green_good,line width=1pt] (frame.north west) -- ++(2cm,0pt);
    \draw[green_good,line width=1pt] (frame.south east) -- ++(-2cm,0pt);
},attach boxed title to top left,boxed title style={frame hidden,interior hidden},title={\color{green_good}\textbf{#1}}}

\newtcolorbox{imp}[1]{enhanced,sharp corners=all,colback=white,colframe=red_good,toprule=0pt,bottomrule=0pt,leftrule=1pt,rightrule=1pt,overlay={
    \draw[red_good,line width=1pt] (frame.north west) -- ++(2cm,0pt);
    \draw[red_good,line width=1pt] (frame.south east) -- ++(-2cm,0pt);
},attach boxed title to top left,boxed title style={frame hidden,interior hidden},title={\color{red_good}\textbf{#1}}}

\newtcolorbox{exemple}{enhanced,sharp corners=all,colback=white,colframe=pink_good,toprule=0pt,bottomrule=0pt,leftrule=1pt,rightrule=1pt,overlay={
    \draw[pink_good,line width=1pt] (frame.north west) -- ++(2cm,0pt);
    \draw[pink_good,line width=1pt] (frame.south east) -- ++(-2cm,0pt);
},attach boxed title to top left,boxed title style={frame hidden,interior hidden},title={\color{pink_good}\textbf{Exemple}}}
...
\definecolor{red_good}{RGB}{165,50,75}
\definecolor{green_good}{RGB}{137,152,120}
\definecolor{pink_good}{RGB}{239,168,198}
\hypersetup{
...
\newcommand{\dtot}[2]{\frac{\mathrm{d} #1}{\mathrm{d} #2}}